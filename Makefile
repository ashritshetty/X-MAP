#############################################################################
# Makefile for building: pacube
# Generated by qmake (3.0) (Qt 5.7.1)
# Project:  qt-pacube\pacube.pro
# Template: app
# Command: C:\Qt\5.7\mingw53_32\bin\qmake.exe -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" -o Makefile qt-pacube\pacube.pro
#############################################################################
...
Makefile: qt-pacube/pacube.pro C:/Qt/5.7/mingw53_32/mkspecs/win32-g++/qmake.conf C:/Qt/5.7/mingw53_32/mkspecs/features/spec_pre.prf \
